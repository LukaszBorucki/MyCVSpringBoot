...
public class EducationDTO {
    ...
    public EducationDTO(int id, String startDate, String endDate, String academy, String faculty, String course
            , String levelOfEducation, String thesisTopic, String appliedTechnologies, String language
            , String logotype) {
        this.id = id;
